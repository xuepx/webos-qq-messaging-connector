enyo.kind({
	...
	components: [
		{ name: "credService", kind: "PalmService", service: "palm://cn.xuepx.qq.service/", method: "checkCredentials", onSuccess: "credSuccess", onFailure: "credFailure" },
		{ name: "syncService", kind: "PalmService", service: "palm://cn.xuepx.qq.service/", method: "sendIM", onSuccess: "syncSuccess", onFailure: "syncFailure" },
		{ name: "createAccount", kind: "PalmService", service: "palm://cn.xuepx.qq.service/", method: "loginStateChanged", onSuccess: "createSuccess", onFailure: "createFailure" },
		{ name: "disenableAccountCap", kind: "PalmService", service: "palm://cn.xuepx.qq.service/", method: "onEnabled", onSuccess: "enabledSuccess", onFailure: "enabledFailure" },
		{ name: "deleteAccount", kind: "PalmService", service: "palm://cn.xuepx.qq.service/", method: "onDelete", onSuccess: "deletedSuccess", onFailure: "deletedFailure" },
		{ name: "startActivity", kind: "PalmService", service: "palm://cn.xuepx.qq.service/", method: "startActivity", onSuccess: "startSuccess", onFailure: "startFailure" },
		{ name: "adoptActivity", kind: "PalmService", service: "palm://cn.xuepx.qq.service/", method: "adoptActivity", onSuccess: "adoptSuccess", onFailure: "adoptFailure" },
		{ name: "completeActivity", kind: "PalmService", service: "palm://cn.xuepx.qq.service/", method: "completeActivity", onSuccess: "completeSuccess", onFailure: "completeFailure" },
		{kind: "PageHeader", components: [
			{content: "qq Messaging Connector Test Panel"}
		]},
		{ name: "Results" },
